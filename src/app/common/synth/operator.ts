...
// export function Operator(params, baseFrequency, envelope, lfo) {
//   this.phase = 0;
//   this.val = 0;
//   this.params = params;
...
//   this.val =
//     Math.sin(this.phase + mod) * this.envelope.render() * this.lfo.renderAmp();
...
export class Operator {
  ...
  updateFrequency(baseFrequency) {
    var frequency = this.params.oscMode
      ...
      : baseFrequency *
        this.params.freqRatio *
        Math.pow(this.OCTAVE_1024, this.params.detune);
