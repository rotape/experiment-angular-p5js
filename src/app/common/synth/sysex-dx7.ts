...
export var SysexDX7 = {
  ...
  extractPatchFromRom: function (bankData, patchId) {
    ...
    for (var i = 5; i >= 0; --i) {
      ...
      var operator: Operator = operators[i];

      operator.rates = [
        oscData.charCodeAt(0),
        oscData.charCodeAt(1),
        oscData.charCodeAt(2),
        oscData.charCodeAt(3),
      ];
      operator.levels = [
        oscData.charCodeAt(4),
        oscData.charCodeAt(5),
        oscData.charCodeAt(6),
        oscData.charCodeAt(7),
      ];
    ...
    return {
      ...
      pitchEnvelope: {
        rates: [
          voiceData.charCodeAt(102),
          voiceData.charCodeAt(103),
          voiceData.charCodeAt(104),
          voiceData.charCodeAt(105),
        ],
        levels: [
          voiceData.charCodeAt(106),
          voiceData.charCodeAt(107),
          voiceData.charCodeAt(108),
          voiceData.charCodeAt(109),
        ],
      },
      controllerModVal: 0,
      aftertouchEnabled: 0,
