...
import defaultPresets from "../common/synth/default-presets.js";
import SysexDX7 from '../common/synth/sysex-dx7.js';
import FMVoice from '../common/synth/voice-dx7.js';
@Injectable({
  providedIn: "root",
})
export class PresetCtrlService {
  ...
  save() {
	...
	reset() {
      ...
      const basePresets = 
		localStorage.removeItem(`${[this.selectedIndex]}`);
